...
// - The nested function can access the parent function varibale due to the fact that it's a direct child  of the function which gives it access to the scope and varibables of the parent
...
function lowerCaseNames(zooAnimals) {
  const newArray = zooAnimals.map((element) =>
